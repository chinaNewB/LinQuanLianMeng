...
public class ScrollingUtil {
    ...
    public static boolean isViewToBottom(View view, int mTouchSlop) {
        ...
        if(view instanceof TbNestedScrollView) return isisTbNestScrollViewToBottom((TbNestedScrollView) view);
        if (view instanceof ViewGroup) return isViewGroupToBottom((ViewGroup) view);
        return false;
    }

    private static boolean isisTbNestScrollViewToBottom(TbNestedScrollView view) {
