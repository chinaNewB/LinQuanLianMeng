...
public class ScanQrCodeActivity extends FragmentActivity {
    ...
    public void handleDecode(Result result) {
        ...
        LogUtils.d(this,"二维码/条形码 扫描结果"+result1);
        //  2020/4/9 处理扫描结果
        //二维码/条形码 扫描结果https://uland.taobao.com/coupon/edetail?e=5HOM4AMIsJQNfLV8niU3R5TgU2jJNKOfNNtsjZw%2F%2FoLgmHBe1jitRo4bdFnqcppV7o0IJ5DByp8ic4n%2BkLcj1MuRTiT9oEhVZV8pr6FWc0OECwFk1cXx9p%2Bk6aIH1vV0mMHpNfYdHdBwWfUaU7r%2BdMHdg8oYVc%2FsB3IEI%2FtGZdTSBjM3vXy9T344d%2BzmctAY&&app_pvid=59590_11.88.161.10_657_1586425018879&ptl=floorId:31539;app_pvid:59590_11.88.161.10_657_1586425018879;tpp_pvid:&union_lens=lensId%3AOPT%401586425019%400b58a10a_0e85_1715e4cbaa1_9f79%4001

        if (result1.contains("taobao.com")) {
            //属于淘宝联盟二维码
//            PresenterManager.getInstance().getTicketPresenter().getTicket("",result1,"");
            //跳转到淘口令界面
